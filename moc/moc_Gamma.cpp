...
QT_MOC_LITERAL(1, 6, 11), // "changeGamma"
QT_MOC_LITERAL(2, 18, 0) // ""

    },
    "Gamma\0changeGamma\0"
};
...
void Gamma::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Gamma *_t = static_cast<Gamma *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeGamma((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject Gamma::staticMetaObject = {
    { &ImageFilter::staticMetaObject, qt_meta_stringdata_Gamma.data,
      qt_meta_data_Gamma,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
